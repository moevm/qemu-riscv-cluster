...
class FileClient:
    def __init__(self):
        self.host = os.getenv('GRPC_CLIENT_HOST')
    ...
    def upload_and_validate(self, file_path, file_type):
...
def test_file_upload():
    ...
    valid_text = PayloadGenerator(size=10, file_type="text", unit="MB").generate(filename= "hello_text")
    ...
    binary_file = PayloadGenerator(size=2048, file_type="binary").generate(filename= "hello_bin")
